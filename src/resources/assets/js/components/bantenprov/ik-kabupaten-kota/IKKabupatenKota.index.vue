<template>
  <div class="card">
    <div class="card-header">
      <i class="fa fa-table" aria-hidden="true"></i> Indikator Kemiskinan Kabupaten-Kota
...
export default {
  ...
  methods: {
    createRow() {
      window.location = '#/admin/ik-kabupaten-kota/create';
    },
    viewRow(rowData) {
      window.location = '#/admin/ik-kabupaten-kota/' + rowData.id;
    },
    editRow(rowData) {
      window.location = '#/admin/ik-kabupaten-kota/' + rowData.id + '/edit';
    },
    deleteRow(rowData) {
      let app = this;

      if (confirm('Do you really want to delete it?')) {
        axios.delete('/api/ik-kabupaten-kota/' + rowData.id)
